...
Read `${CLAUDE_PLUGIN_ROOT}/skills/browse/references/commands.md` for the full command reference, setup instructions, @ref system, and troubleshooting. Set up `$B` before doing anything else.
