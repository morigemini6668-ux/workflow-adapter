...
const COMMANDS: Record<string, { description: string; usage?: string }> = {
  ...
  install:    { description: 'Install uniflow plugin for Claude Code / Codex', usage: 'uniflow install' },
  start:      { description: 'Start daemon + orchestrator session', usage: 'uniflow start [--cli claude|codex] [--tui]' },
  ...
  spawn:      { description: 'Spawn a worker agent', usage: 'uniflow spawn <name> [--cli claude|codex] [--role executor] [--mode interactive|non_interactive]' },
  send:       { description: 'Send message to agent inbox', usage: 'uniflow send <agent> <message> [--interrupt|--nudge]' },
  assign:     { description: 'Assign task to agent', usage: 'uniflow assign <task-id> <agent>' },
  'task-add': { description: 'Create a new task', usage: 'uniflow task-add <subject> [--assign agent] [--priority 1-5] [--depends-on id,id]' },
  agents:     { description: 'List agents', usage: 'uniflow agents' },
  tasks:      { description: 'List tasks', usage: 'uniflow tasks [--status pending|in_progress|completed|failed]' },
  ...
  worktree:   { description: 'Manage git worktrees', usage: 'uniflow worktree <create|merge> [options]' },
