...
AskUserQuestion({
  questions: [{
    ...
    header: "Confirm",
    options: [
      { label: "Approve", description: "Findings look good. Save results and stop here." },
